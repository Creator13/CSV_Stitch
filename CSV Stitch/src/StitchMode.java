public enum StitchMode {
	...
	COPY_ALL("Copy all headers", "Copy the full files into a new file, including their headers", false), 
	...
	DETECT_HEADER("Detect header", "Detects the header automatically using an algorithm.", true), 
